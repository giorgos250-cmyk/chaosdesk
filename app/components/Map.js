...
function SusBadge() {
  return (
    <span style={{
      ...
      borderRadius: 3, fontFamily: "'Oswald',sans-serif",
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ fontFamily: "'Source Code Pro',monospace", fontSize: 20, color: cfg.color }}>▓</span>
          <span style={{
        ...
        <button onClick={onClose} style={{
          ...
          fontFamily: "'Source Code Pro',monospace", fontSize: 18, padding: '2px 12px',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontFamily: "'Oswald',sans-serif", fontSize: 17, letterSpacing: '0.12em', color: C.inkMid }}>
          FIELD REPORT — {conflict.id?.toUpperCase()}
        </span>
        <button onClick={onClose} style={{
          background: 'none', border: 'none', fontFamily: "'Oswald',sans-serif",
...
function SectionHead({ text, color }) {
  return (
    <div style={{
      fontFamily: "'Oswald',sans-serif", fontSize: 17, letterSpacing: '0.15em',
...
function CardContent({ conflict, dark = false, onIntel }) {
  ...
  return (
    <div>
      {/* Title */}
      <h2 style={{
        fontFamily: "'Oswald',sans-serif", fontSize: 'clamp(28px, 7vw, 44px)', letterSpacing: '0.08em',
      ...
      {/* Meme title */}
      <div style={{
        fontFamily: "'Source Code Pro',monospace", fontSize: 'clamp(16px, 4vw, 22px)', color: cfg.color,
      ...
      <div style={{
        ...
        marginBottom: 28, fontFamily: "'Source Code Pro',monospace",
              ...
              <div key={i} style={{
                ...
                {memeImgs[i] ? (
                  ...
                  <div style={{
                    ...
                    <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 22, color: dark ? '#fff' : C.ink, textAlign: 'center', letterSpacing: '0.06em', lineHeight: 1.2 }}>{meme.text_top || ''}</div>
                    ...
                    <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 20, color: dark ? '#fff' : C.ink, textAlign: 'center', letterSpacing: '0.06em', lineHeight: 1.2 }}>{meme.text_bottom || ''}</div>
                  </div>
                )}
                <div style={{ padding: '8px 14px', borderTop: `1px solid ${borderC}`, display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ fontFamily: "'Source Code Pro',monospace", fontSize: 16, color: cfg.color }}>{meme.format}</span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 8 }}>
            {Object.entries(conflict.data_points).map(([k, v]) => (
              <div key={k} style={{ padding: '12px 16px', background: surfaceC, border: `1px solid ${borderC}`, borderRadius: 4 }}>
                ...
                <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 'clamp(20px, 5vw, 28px)', color: cfg.color }}>{v}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          {conflict.latest_updates.map((u, i) => (
            <div key={i} style={{ display: 'flex', gap: 14, padding: '14px 0', borderBottom: `1px solid ${borderC}` }}>
              <div style={{ fontFamily: "'Source Code Pro',monospace", fontSize: 18, color: i === 0 ? cfg.color : txtFaint, minWidth: 58, whiteSpace: 'nowrap' }}>{u.date}</div>
              <div style={{ minWidth: 0 }}>
                <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 20, color: txt, marginBottom: 4, wordBreak: 'break-word' }}>{u.headline}</div>
              ...
              return (
                <div key={side} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                    ...
                    <span style={{ fontFamily: "'Oswald',sans-serif", fontSize: 17, letterSpacing: '0.1em', color: sc }}>{side.toUpperCase()}</span>
                  </div>
  ...
  return (
    <>
      <button onClick={onToggle} style={{
        ...
        color: C.ink, fontFamily: "'Oswald',sans-serif",
      ...
      <div style={{
        ...
        <div style={{ padding: '18px 20px', borderBottom: `1px solid ${C.border}`, flexShrink: 0 }}>
          <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 28, letterSpacing: '0.2em', color: C.ink }}>CHAOSDESK</div>
          ...
          {vibeCheck && <div style={{ fontFamily: "'Source Code Pro',monospace", fontSize: 14, color: C.inkLight, marginTop: 6, lineHeight: 1.4 }}>{vibeCheck}</div>}
        </div>
          ...
          {conflicts?.map((c) => {
            ...
            return (
              <div key={c.id} onClick={() => onSelect(c)} style={{
                ...
                <div style={{ fontFamily: "'Oswald',sans-serif", fontSize: 20, color: C.ink, lineHeight: 1.1 }}>{c.name}</div>
