    ...
    <div style={{
      ...
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .ib{font-family:'Oswald',sans-serif;font-size:clamp(14px,3.5vw,20px);letter-spacing:0.22em;background:transparent;border:2px solid #c4bfb6;color:#c4bfb6;padding:14px 36px;cursor:not-allowed;transition:all .3s;min-width:240px;}
